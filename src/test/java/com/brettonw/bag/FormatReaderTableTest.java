...
public class FormatReaderTableTest {
    ...
    public void testBasicFixedFormatWithFieldNames () {
        ...
        AppTest.report (bagArray.getCount (), 4, "4 valid rows were provided");
        AppTest.report (bagArray.getBagObject (1).getString ("A"), "aaa", "row 0, 1st element reads correctly");
        AppTest.report (bagArray.getBagObject (1).getString ("D"), "dddd", "row 0, 4th element reads correctly");
        AppTest.report (bagArray.getBagObject (3).getInteger ("A"), 11, "row 1, 1st element reads correctly");
        AppTest.report (bagArray.getBagObject (3).getInteger ("D"), 4444, "row 1, 4th element reads correctly");
    }
}
